...
__device__ float AtomicAdd_load_forward_0(AtomicAdd_0 this_0, uint i_0)
{
    float _S1 = ((this_0.diff_0).load<float>((i_0)));
    return _S1;
}

__device__ void AtomicAdd_load_backward_0(AtomicAdd_0 this_1, uint i_1, float dOut_0)
{
    float oldVal_0;
...
__device__ void AtomicAdd_store_forward_0(AtomicAdd_0 this_2, uint i_2, float dx_0)
{
    (this_2.diff_0).store<float>((i_2), (dx_0));
    return;
}

__device__ float AtomicAdd_store_backward_0(AtomicAdd_0 this_3, uint i_3)
{
    float oldVal_1;
    float _S2 = (*((&oldVal_1)) = atomicExch((this_3.diff_0).data_ptr_at<float>((i_3)), (0.0f)));
    return oldVal_1;
}
...
{
    uint _S3 = ((this_4.primal_0).sizes[(i_4)]);
    return _S3;
}
...
__device__ DiffPair_float_0 DiffTensorView_load_forward_0(DiffTensorView_0 this_5, uint x_0)
{
    float _S4 = ((this_5.primal_0).load<float>((x_0)));
    DiffPair_float_0 _S5 = { _S4, AtomicAdd_load_forward_0(this_5.diff_1, x_0) };
    return _S5;
}

__device__ void DiffTensorView_load_backward_0(DiffTensorView_0 this_6, uint x_1, float dOut_1)
{
    AtomicAdd_load_backward_0(this_6.diff_1, x_1, dOut_1);
    return;
}

__device__ float DiffTensorView_load_0(DiffTensorView_0 this_7, uint i_5)
{
    float _S6 = ((this_7.primal_0).load<float>((i_5)));
    return _S6;
}

__device__ void DiffTensorView_store_forward_0(DiffTensorView_0 this_8, uint x_2, DiffPair_float_0 dpval_0)
{
    (this_8.primal_0).store<float>((x_2), (dpval_0.primal_1));
    AtomicAdd_store_forward_0(this_8.diff_1, x_2, dpval_0.differential_0);
    return;
}

__device__ void DiffTensorView_store_backward_0(DiffTensorView_0 this_9, uint x_3, DiffPair_float_0 * dpval_1)
{
    float _S7 = AtomicAdd_store_backward_0(this_9.diff_1, x_3);
    dpval_1->primal_1 = (*dpval_1).primal_1;
    dpval_1->differential_0 = _S7;
    return;
}

__device__ void DiffTensorView_store_0(DiffTensorView_0 this_10, uint x_4, float val_0)
{
    (this_10.primal_0).store<float>((x_4), (val_0));
    return;
}

struct s_bwd_prop_square_Intermediates_0
{
    float _S8;
    float _S9;
    uint _S10;
...
__device__ float s_primal_ctx_DiffTensorView_load_0(DiffTensorView_0 _S11, uint _S12)
{
    return DiffTensorView_load_0(_S11, _S12);
}

__device__ void s_primal_ctx_DiffTensorView_store_0(DiffTensorView_0 _S13, uint _S14, float _S15)
{
    DiffTensorView_store_0(_S13, _S14, _S15);
    return;
}

__device__ void s_bwd_primal_square_0(DiffTensorView_0 input_0, DiffTensorView_0 output_0, s_bwd_prop_square_Intermediates_0 * _s_diff_ctx_0)
{
    _s_diff_ctx_0->_S8 = 0.0f;
    _s_diff_ctx_0->_S9 = 0.0f;
    _s_diff_ctx_0->_S10 = 0U;
    _s_diff_ctx_0->_S8 = 0.0f;
    _s_diff_ctx_0->_S9 = 0.0f;
    uint _S16 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    uint _S17 = DiffTensorView_size_0(input_0, 0U);
    _s_diff_ctx_0->_S10 = _S17;
    if(!(_S16 >= _S17))
    {
        float _S18 = s_primal_ctx_DiffTensorView_load_0(input_0, _S16);
        _s_diff_ctx_0->_S8 = _S18;
        float _S19 = s_primal_ctx_DiffTensorView_load_0(input_0, _S16);
        _s_diff_ctx_0->_S9 = _S19;
        s_primal_ctx_DiffTensorView_store_0(output_0, _S16, _S18 * _S19);
    }
    return;
}

__device__ void s_bwd_prop_DiffTensorView_store_0(DiffTensorView_0 _S20, uint _S21, DiffPair_float_0 * _S22)
{
    DiffTensorView_store_backward_0(_S20, _S21, _S22);
    return;
}

__device__ void s_bwd_prop_DiffTensorView_load_0(DiffTensorView_0 _S23, uint _S24, float _S25)
{
    DiffTensorView_load_backward_0(_S23, _S24, _S25);
    return;
}

__device__ void s_bwd_prop_square_0(DiffTensorView_0 input_1, DiffTensorView_0 output_1, s_bwd_prop_square_Intermediates_0 _s_diff_ctx_1)
{
    uint _S26 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    bool _S27 = !(_S26 >= _s_diff_ctx_1._S10);
    if(_S27)
    {
        s_primal_ctx_DiffTensorView_store_0(output_1, _S26, s_primal_ctx_DiffTensorView_load_0(input_1, _S26) * s_primal_ctx_DiffTensorView_load_0(input_1, _S26));
    }
    float _S28;
    if(_S27)
    {
        _S28 = _s_diff_ctx_1._S8 * _s_diff_ctx_1._S9;
    }
    else
    {
        _S28 = 0.0f;
    ...
    if(_S27)
    {
        ...
        s_bwd_prop_DiffTensorView_store_0(output_1, _S26, &_S29);
        float _S30 = _s_diff_ctx_1._S9 * _S29.differential_0;
        s_bwd_prop_DiffTensorView_load_0(input_1, _S26, _s_diff_ctx_1._S8 * _S29.differential_0);
        s_bwd_prop_DiffTensorView_load_0(input_1, _S26, _S30);
    }
    return;
}

__device__ void s_bwd_square_0(DiffTensorView_0 _S31, DiffTensorView_0 _S32)
{
    s_bwd_prop_square_Intermediates_0 _S33;
    s_bwd_primal_square_0(_S31, _S32, &_S33);
    s_bwd_prop_square_0(_S31, _S32, _S33);
    return;
}

extern "C" {
__global__ void __kernel__square_bwd_diff(DiffTensorView_0 _S34, DiffTensorView_0 _S35)
{
    s_bwd_square_0(_S34, _S35);
    return;
}

}
__device__ void s_fwd_square_0(DiffTensorView_0 input_2, DiffTensorView_0 output_2)
{
    uint _S36 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    if(_S36 >= DiffTensorView_size_0(input_2, 0U))
    {
        return;
    }
    DiffPair_float_0 _S37 = DiffTensorView_load_forward_0(input_2, _S36);
    DiffPair_float_0 _S38 = DiffTensorView_load_forward_0(input_2, _S36);
    DiffPair_float_0 _S39 = { _S37.primal_1 * _S38.primal_1, _S37.differential_0 * _S38.primal_1 + _S38.differential_0 * _S37.primal_1 };
    DiffTensorView_store_forward_0(output_2, _S36, _S39);
    return;
}

extern "C" {
__global__ void __kernel__square_fwd_diff(DiffTensorView_0 _S40, DiffTensorView_0 _S41)
{
    s_fwd_square_0(_S40, _S41);
    return;
}

}
extern "C" {
__global__ void __kernel__square(DiffTensorView_0 input_3, DiffTensorView_0 output_3)
{
    uint _S42 = (((threadIdx)) + ((blockIdx)) * ((blockDim))).x;
    if(_S42 >= DiffTensorView_size_0(input_3, 0U))
    {
        return;
    }
    DiffTensorView_store_0(output_3, _S42, DiffTensorView_load_0(input_3, _S42) * DiffTensorView_load_0(input_3, _S42));
    return;
}
